...
class TestDevelopmentConfig(TestCase):
    def create_app(self):
        app.config.from_object("project.config.server_config.DevelopmentConfig")
        return app
...
class TestTestingConfig(TestCase):
    def create_app(self):
        app.config.from_object("project.config.server_config.TestingConfig")
        return app
...
class TestProductionConfig(TestCase):
    def create_app(self):
        app.config.from_object("project.config.server_config.ProductionConfig")
        return app
